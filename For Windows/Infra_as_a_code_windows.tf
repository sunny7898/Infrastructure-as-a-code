...
resource "aws_s3_bucket_object" "home_folder" {
	...
	key     = "sobj.png"
	source = "C:/Users/a/Videos/Projects/Hybrid/Key.png"
	acl    = "public-read"
}
/*
	provisioner "local-exec" {
		command = "aws s3 cp C:/Users/a/Videos/Projects/Hybrid/ ${aws_s3_bucket.bucket1.id}"
	}
}
*/
...
depends_on = [
	...
	provisioner "local-exec" {
	    command = "start chrome  http://${aws_instance.Proj1_EC2.public_ip}/"
  	}
}
